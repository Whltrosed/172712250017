!function(){
  ...
  if( !isInit ){
    ...
    const GCJSDATA = [
      {
        name: '某某市人民法院审判法庭工程, 招标编号：GC20190003',
        content: `1.工程名称: 某某市人民法院审判法庭工程\n2.项目审批机关名称某某市发展和改革委员会\n3.招标人: 某某市人民法院\n4.资金来源: 财政\n5.交易项目性质: 建筑工程`,
        time: '2019/05/09',
        state: 0
      }, {
        name: '某某县看守所武警中队营房建设项目, 招标编号：GC20190156',
